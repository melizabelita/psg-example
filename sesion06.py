...
var_booleana = bool(1)
print("var_booleana = bool(1)")
print (var_booleana)
print (type(var_booleana))
print("var_booleana = bool(0)")
var_booleana = bool(0)
print (var_booleana)
print (type(var_booleana))
print("var_booleana = bool(15)")
...
print("print (10 >= 10)")
print (10 >= 10)
print("A nivel de objeto")
print("print (10 is 10)")
print (10 is 10)
print("print (10 is not 10)")
print (10 is not 10)
print("print (10 is 10.0)")
print (10 is 10.0)
print("print (10 is not 10.0)")
...
x = 10
mayor_que_cero = x > 0
print("print (mayor_que_cero)")
print (mayor_que_cero)
diferente_de_10 = x != 10
print("print (diferente_de_10 = x != 10)")
...
print("Nota2", nota2)
print("Nota3", nota3)
print("Nota Final", nota1 + nota2 + nota3)
...
print (numero % 3 ==0)
print ("Es divisible entre 3?", numero % 3 ==0)
print ("Es divisible entre 5?", numero % 5 ==0)
print ("Es divisible entre 2?", numero % 2 ==0)
print ("No es divisible entre 2?", numero % 2 !=0)
